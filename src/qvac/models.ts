...
export const SIZES = {
  ...
  /** Whisper small (multilingual) speech-to-text — needed for correct
   * non-Latin scripts (Devanagari etc.); base mis-scripts Hindi as Urdu/Latin. */
  transcribe: 264 * 1024 * 1024,
  /** Supertonic TTS (per variant, Q8_0). */
  tts: 252 * 1024 * 1024,
  /** EmbeddingGemma-300M Q4 for the RAG phrasebook. */
  embedding: 278 * 1024 * 1024,
} as const;

/** Multilingual Whisper model used for voice → text. SMALL (not BASE): base
 * mis-transcribes Hindi into Urdu/Latin; small reliably emits Devanagari. */
export const TRANSCRIBE_MODEL = WHISPER_SMALL_Q8_0;
...
export const TTS_MODELS = {
  en: TTS_EN_SUPERTONIC_Q8_0,
  multilingual: TTS_MULTILINGUAL_SUPERTONIC2_Q8_0,
} as const;
